<template>
	<section class="bg-gray-700 text-white py-16 lg:py-32 font-neo-sans">
		<div class="container mx-auto">
			<div class="grid grid-cols-1 lg:grid-cols-2">
				<div class="p-8">
					<div class="uppercase space-y-4">
						<h2 class="text-3xl lg:text-6xl font-bold">{{ $t("ABOUT_US") }}</h2>
						<p class="text-lg lg:text-2xl">{{ $t("OUR_HISTORY_AND_THE_EVOLUTION_OF_CLEANING") }}</p>
					</div>
				</div>
