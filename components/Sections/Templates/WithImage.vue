<template>
	<section class="overflow-hidden lg:grid lg:grid-cols-2 font-neo-sans text-xl" :class="sectionClass">
		<div class="flex justify-center items-center" :class="imageLocation == 'left' ? 'order-2' : ''">
