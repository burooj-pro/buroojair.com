			...
			<div class="container mx-auto p-6">
				<nav>
					<div class="flex flex-wrap items-center justify-between mx-auto font-neo-sans text-lg">
						...
						<button data-collapse-toggle="navbar-default" type="button" class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-white rounded-lg md:hidden focus:bg-brand-first hover:bg-brand-first focus:outline-none" aria-controls="navbar-default" aria-expanded="false">
