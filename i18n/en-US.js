export default {
	...
	FOR_INQUIRIES_PLEASE_USE_OUR_LISTED_CONTACT_INFO: 'For inquiries please use our listed contact info.',
	ADVANTAGES_USING_BUROOJ_AIR_DRONES: 'Benefits of Utilizing Our Cleaning Drones',
	HIGH_SPEED_AND_EFFECTIVE_SURPASSING_TRADITIONAL_METHODS: 'Faster solution saving you time by a factor of 5-10 in terms of results.',
	...
	ACCESSING_ELEVATED_AREAS_WITHOUT_REQUIRING_HEIGHT_SPECIFIC_TOOLS: 'Competitive price compared to other solutions',
	ZERO_CONTACT_ALTERNATIVE: 'Zero-contact alternative.',
	NOW_REQUEST_A_QUOTE_FOR_DRONE_CLEANING: 'Request a Quote',
	ARE_YOU_INTERESTED_IN_HAVING_A_DRONE_CLEAN_THE_WINDOWS_OR_THE_FACADE_OF_YOUR_BUILDING: 'Are you interested in having a drone clean the windows or the facade of your building?',
	YOU_CAN_CONTACT_US_ANYWHERE_IN_THE_WORLD_FOR_A_NON_BINDING_PRICE_QUOTE: 'You can contact us anywhere in the world for a non-binding price quote.',
	SEND_YOUR_INQUIRY_AND_WE_WILL_GET_IN_TOUCH_AS_SOON_AS_POSSIBLE: 'Send your inquiry and we will get in touch as soon as possible',
	DRONE_SERVICES: 'Drone Service',
	CLEANING_BUILDINGS_AND_HEAVY_LIFTING: 'Utilizing aerial technologies to digitize traditional services',
	CLEANING_BUILDINGS: 'CLEANING BUILDING',
	CLEANING_BUILDINGS_DESC: "Offering aerial drone cleaning and sanitization, a safer, faster and less expensive alternation to traditional cleaning methods. Burooj Air's technology and team provide unpresedented solutions to cleaning buildings utlizing drones. Burooj Air's technology and team provide unpresedented solutions to cleaning buildings utlizing drones.",
	READ_MORE: 'Read More',
	HEAVY_LIFTING: 'HEAVY LIFTING',
	HEAVY_LIFTING_DESC: 'Lifting and transporting heavy objects up to 50 kg, such as construction materials or medical supplies. This can be a valuable tool for orgnizations that needs to move heavy objects quickly and efficiently.',
	...
	THE_BEST_SOLUTION_TO_CLEAN_BUILDINGS_AND_LIFT_HEAVY_WEIGHTS_IN_A_FASTER_WAY_IS_AVAILABLE_NOW: 'We are currently offering building cleaning, solar panel cleaning and heavy material lifting by our drones.',
	...
	PARTICIPATE_IN_THE_MOST_CREATIVE: 'Participate in the most creative business concept to hit the cleaning industry in more than a century.',
	...
	OUR_MAIN_GOAL_IS_TO_HELP_OTHERS_AND_MAKE_WORKING_LIFE_BETTER_FOR_EVERYONE: 'Our main goal is to help others and make working life better for everyone.',
	WE_WANT_TO_HELP_MAKE_WORKDAYS: 'We want to help make workdays safer for those who use lifts, scaffolding, and people who scale buildings.',
	THESE_ARE_PHYSICALLY_DEMANDING_JOBS: 'These are physically demanding jobs that frequently include hazard and stress injuries. Burooj Air Drones specializes on assisting this group.',
	...
	THE_ESTIMATED_NEED_FOR_FUTURE_DRONE_CLEANING_SERVICES_IS_APPROXIMATELY: 'THE ESTIMATED NEED FOR FUTURE DRONE CLEANING SERVICES IS APPROXIMATELY',
	DRONES_INTERNATIONALLY: 'DRONES INTERNATIONALLY',
	GLOBAL_REACH: 'GLOBAL REACH',
	REACH_WORLDWIDE: 'REACH WORLDWIDE',
	GLOBAL_REACH_DESC: 'In compliance with the international quality standards ISO 9001, ISO 14001, and OHSAS 1800, Burooj Air Droness have the same concept, safety regulations, and stringent controls and processes.',
	...
	NO_MATTER_WHERE_YOU_ARE_IN_THE_WORLD: 'No matter where you are located, you can utilize our drone cleaning services as we possess authorized operating permissions from the required civil and aviation authorities. Additionally, we offer our franchisee extensive operation training which strictly adhere to the regional civil and aviation regulations.',
	...
	THROUGHOUT_OUR_JOB_SECTORS: 'Throughout our job sectors, HSE and public safety are highly prioritized. Drone use creates a workplace that is safer for both employees and the general public.',
	FUTURE_DEVELOPMENT: 'FUTURE DEVELOPMENT',
	A_LOOK_TOWARDS_FUTURE_INVENTIONS: 'A LOOK TOWARDS FUTURE INVENTIONS',
	WHATS_NEXT: "What's Next",
	UPCOMING: 'UPCOMING',
	ADVANTAGES_OF_GLASS_AND_FACADE_CLEANING_WITH_BUROOJ_AIR_DRONE: 'ADVANTAGES OF GLASS AND FACADE CLEANING WITH BUROOJ AIR WORKING DRONE',
	IMPORTANT_KEY_FACTS: 'Important key facts',
	ENQUIRE_TODAY: 'ENQUIRE TODAY',
	THE_EVOLUTION_OF_HIGH_RISE_WINDOW_AND_FACADE_CLEANING_HAS_ARRIVED: 'The Evolution of High Rise Window & Facade cleaning has Arrived',
	HIGH_RISE_WINDOW_AND_FACADE_CLEANING: 'Cleaning windows and facades',
	FOR_FACADE_AND_WINDOW_CLEANING_WE_USE_MULTIPLE_METHODS: 'For Facade and window cleaning we use multiple methods',
	SETTING_THE_STANDARD_FOR_WORKING_DRONES: 'SETTING THE STANDARD FOR WORKING DRONES',
  ...
  which was founded by Mohammed Bin Faihan. BUROOJ AIR Group
...
CLEANING INDUSTRY`,
	...
	MEET_BUROOJ_AIR_TEAM:' Meet Burooj Air Team ',
	...
	BUROOJ_PRIVATE_LIMITED_COMPANY:'(1) Burooj, a private limited company incorporated under the laws of Saudi Arabia (registered no. XXXXXX) whose registered office is at PRINCE TURKI ST, KHOBAR, SAUDI ARABIA; and',
	THE_VISITOR_TO_THIS_PAGE:'(2) The visitor to this page and recipient of information of the Burooj Air (the Recipient).Together referred to as the Parties and each as a Party to this NDA.',
	BACKGROUND:'BACKGROUND',
	THE_COMPANY_HAS_DEVELOPED:'(A)  The Company has developed a technology for utilizing drones in the cleaning industry and is contemplating a collaboration (the Collaboration) with the Recipient. The Company has therefore invited the Recipient to discuss the possibility of a distribution or resale agreement between the Parties. The Recipient will in connection with such discussions be invited to a demonstration of the drone technology. Furthermore, the Recipient will be provided with certain Confidential Information (as defined in clause 1.1).',
	THIS_NDA_SETS_OUT:'(B)  This NDA sets out the terms and conditions agreed between the Parties in relation to the provision of such Confidential Information by the Company to the Recipient.',
	THE_CONFIDENTIAL_INFORMATION:'(C)  The Confidential Information provided by the Company to the Recipient will be provided on a non-exclusive basis, and this NDA does not restrict the Company from giving the same Confidential Information to any other entities.',
	AGREED_TERMS:'AGREED TERMS',
	CONFIDENTIALITY:'1 Confidentiality',
	FOR_THE_PURPOSE_OF_THIS_NDA:'1.1  For the purpose of this NDA, Confidential Information shall mean all information (however recorded or preserved) which is or has been, either directly or indirectly, disclosed or made available to the Recipient (in any form or medium), in connection with the demonstration of the drone technology and Recipient considering the Collaboration, and shall also include any and all information regarding the existence, nature or progress of any discussions between the Parties relating to the possible Collaboration, including the demonstration of the drone technology.',
	THE_RECIPIENT_SHALL_KEEP:'1.2  The Recipient shall keep all Confidential Information strictly confidential and shall not disclose any Confidential Information to any third party.',
	THE_RECIPIENT_MAY_DISCLOSE_CONFIDENTIAL_INFORMATION:'1.3  The Recipient may disclose Confidential Information only when so required by law or any court of competent jurisdiction, provided that the Company is given due notice prior to such disclosure.',
	...
	THE_FORGOTTEN_OBLIGATION:'1.5  The foregoing obligations of confidentiality shall not apply to Confidential Information:',
	WHICH_IS_ALREADY_KNOWN:'(a)  Which is already known to the public or becomes available to the public other than through the act or omission of the Recipient or its Representatives;',
	WHICH_THE_RECIEPENT:'(b)  Which the Recipient can prove was known to it prior to the date and time the Recipient received such Confidential Information from the Company;',
	WHICH_THE_RECIEPENT_CAN_PROVE:'(c)  which the Recipient can prove was disclosed to it by a third party which is not, to the knowledge of the Recipient, acting in breach of any obligation of confidentiality towards the Company; or',
	WHICH_THE_RECIEPENT_CAN_PROVE_HAS_BEEN_DEVELOPED:'(d)  which the Recipient can prove has been developed by the Recipient or its Representatives entirely independently of any Confidential Information supplied hereunder.',
	THE_RECIPIENT_ACKNOWLEDGS:'1.6  The Recipient acknowledges that the Confidential Information has commercial value and is the property of the Company, and all ownership of the Confidential Information will remain with the Company. The Recipient must take all steps necessary to safeguard the confidentiality of the Confidential Information.',
	USE_OF_THE_CONFIDENTIAL_INFORMATION:'2  Use of the Confidential Information – Approved Purpose',
	THE_RECIPIENT_SHALL_NOT_USE:'The Recipient shall not use, directly or indirectly, any Confidential Information for any other purpose whatsoever other than evaluating, preparing for, negotiating, and carrying out the Collaboration (Approved Purpose). The Recipient must not profit from the use of the Confidential Information, except in respect of the Approved Purpose',
	STORING_AND_RETURN_CONFIDENTIAL_INFORMATION:'3 Storing and return of the Confidential Information',
	...
	THE_RECIPIENT_SHALL_AT_ITS_OWN_EXPENSE:'3.2 The Recipient shall at its own expense, within five days of receipt of a written notification from the Company:',
	RETURN_OR_DESTROY_ALL_WRITTEN:'(a) Return or destroy all written Confidential Information provided to the Recipient or its Representatives without keeping any copies;',
	DESTROY_ALL_ANALYSES:'(b)  Destroy all analyses, notes, or other documents prepared by the Recipient or its Representatives which contain or otherwise reflect Confidential Information;',
	DELETE_ORCAUSE_THE_DELETION:'(c)  Delete or cause the deletion of all Confidential Information from any computer or other device in the possession or under the control of the Recipient or its Representatives; and',
	ON_REQUEST_CONFIRM:'(d)  On request confirm in writing that clause 3.2 has been fully complied with.',
	NON_COMPETITION_NON_SOLICITATION_AND_NON_RECRUITMENT:'4 Non-competition, non-solicitation, and non-recruitment',
	DURING_THE_DURATION_OF_THIS_AGREEMENT:'4.1  During the duration of this Agreement, the Recipient will not, and will ensure that the Recipient does not, without the prior written consent of the Company, either directly or indirectly become involved or participate in any capacity in any business, activities, decisions, operations, undertakings or concerns which, in the reasonable opinion of the Company:',
	CONFLICT_OR_APPEAR_TO_CONFLICT:'(a)  Conflict, or appear to conflict, with the interests of the Company; and',
	ARE_IN_COMPETITION_WITH:'(b)  Are in competition with, or are of a similar nature to, the activities of the Company',
	IN_CONNECTION_WITH_THE_RECIPIENT:'4.2  In connection with the Recipient considering the Collaboration, the Recipient and its Representatives shall not contact any of the Company’s employees, suppliers, or customers without the Company’s prior written consent.',
	THE_RECIPIENT_SHALL_NOT_SOLICIT:'4.3  The Recipient shall not solicit or entice or endeavour to solicit or entice any existing supplier, customer, or other contract or trading party of the Company to terminate or alter their business relationship with the Company. This clause 4.3 shall remain in force during the negotiations regarding the Collaboration and for 12 months after the termination of such negotiations if the negotiations are not successful.',
	THE_RECIPIENT_SHALL_NOT_SOLICIT_OR_ENTICE:'4.4  The Recipient shall not solicit or entice or endeavor to solicit or entice any directors, employees, or other representatives of the Company, or consultants delivering services to the Company, to leave their current employment. This clause shall remain in force during the negotiations regarding the Collaboration and for 12 months after the termination of such negotiations if the negotiations are not successful.',
	THE_RECIPIENT_ACKNOWLEDGS_THAT:'4.6  The Recipient acknowledges that the covenants in respect of non-competition contained in this clause are fair and reasonable and that the Company is relying upon this acknowledgment in entering into this agreement. The Recipient will ensure that the Recipient"s directors, employees, and agents will make the same acknowledgment.',
	...
	THE_RECIPIENT_AGREES_AND_ACKNOWLEDGS_THAT_IT_SHALL_NOT_OBTAIN:'5.1  The Recipient agrees and acknowledges that it shall not obtain any rights, title, estate, or other interest of any nature whatsoever in or to the Confidential Information.',
	THE_RECIPIENT_SHALL_IMMEDIETLLY:'5.2  The Recipient shall immediately notify the Company if the Recipient or any of its Representatives becomes aware of any actual, threatened, or likely disclosure of Confidential Information to an unauthorized party.',
	THE_RECIPIENT_HEREBY_AGREES:'5.3  The Recipient hereby agrees to fully indemnify the Company, its directors, and owners against any liabilities, costs, expenses, damages, and losses that the Company, its directors, and owners may suffer or incur as a result of or in connection with any breach of the Recipient’s and its Representatives’ undertakings or obligations in this NDA.',
	...
	THE_COMPANY_ITS_AFFILIATES:'5.5  The Company, its affiliates and advisers, and their respective employees, directors, and agents shall have no liability to the Recipient or any of its Representatives for any error or omission in the Confidential Information and may at any time refrain from submitting additional Confidential Information.',
	IF_ANY_PROVISION_OF_THIS_NDA:'5.6  If any provision of this NDA is held to be unlawful, invalid, unenforceable, or in conflict with any rule of law, statute, ordinance, or regulation, it is to be severed so that the validity and enforceability of the remaining provisions are not affected.',
	THIS_NDA_SHALL_NOT_CREATE:'5.7  This NDA shall not create any obligation on either Party to enter into any form of agreement and each Party reserves the right, at its sole discretion, to terminate at any time the discussions concerning the Collaboration.',
	THE_RECIPIENT_SHALL_NOT_DISCLOSE_THE_CONFIDENTIAL_INFORMATION:'5.8  The Recipient shall not disclose the Confidential Information to any of its affiliated companies or owners unless such disclosure first is permitted by the Company and such company or owner signs a confidentiality agreement on substantially the same terms as this NDA.',
	COMMENCEMENT_AND_TERM:'6 Commencement and term',
	THIS_NDA_SHALL_COME_INTO_EFFECT:'6.1  This NDA shall come into effect on the Effective Date.',
	THIS_NDA_SHALL_REMAIN_IN_FULL_FORCE:'6.2  This NDA shall remain in full force and effect for a period of 36 months from the Effective Date.',
	GOVERNING_LAW_AND_JURISDICTION:'7 Governing law and jurisdiction',
	ALL_MATTERS_RELATED_TO_THE_NDA:'7.1  All matters related to the NDA shall be subject to and governed by the laws of Saudi Arabia.',
	ANY_DISPUTE_CONTROVERSY:'7.2  Any dispute, controversy, or claim arising out of or in connection with this NDA shall be referred to and settled by the Saudi Arabia courts as the agreed legal venue. Nothing herein shall limit the right of any party to this NDA to seek to obtain in any court of competent jurisdiction any interim relief or provisional remedy, including injunctive relief.',
